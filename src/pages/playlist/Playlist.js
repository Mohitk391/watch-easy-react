                    ...
                    { playlists.length>0 ? playlists.map(playlist=> {
                        ...
                        <div className="card horizontal-card playlist">
                            <div className="card-content-horizontal">
                                <div className="card-title">Playlist 01</div>
                                <div className="playlist-content-details">10 videos | 34:26 minutes</div>
                            </div>
                ...
                <div className="create-playlist flex flex-column ">
                    ...
                    <form className="flex flex-column flex-gap-1">
                        <div className="cp-content flex flex-column">
                            ...
                            <input type="text" placeholder="My Playlist" id="playlistName" onChange={e=> setFormInputs({...formInputs, title: e.target.value})}/>
                            <label htmlFor="playlistDescription">Playlist Description</label>
                            <input type="text" placeholder="Here decription for the playlist comes" id="playlistDescription"onChange={e=> setFormInputs({...formInputs, description: e.target.value})}/>
                        </div>
